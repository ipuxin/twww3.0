...
<div class="navbar top1 top1V2" style="min-height: 90px;">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand navbar-brandV2" href="<?= Url::to(['site/index'])?>">
                <img style="margin-top: 10px;" src="/images/logo.png" class="img-responsive col-md-2"></a>
        </div>
        <div class="navbar-collapse collapse" role="navigation">
            <ul class="nav navbar-nav navbar-navV2">

            </ul>
            <div class="pull-right mianTips"><?= $session->get('phone')?>
            | <a href="<?= Url::to(['person/logout'])?>" class="mybtnmain">退出</a></div>
        </div>
    </div>
</div>
