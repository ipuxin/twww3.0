...
<input type="hidden" name="Seller[type]" value="企业">
...
<div class="form-group field-person-cityname required">
    ...
    <div class="  formControls col-lg-5     ">
        ...
        <select class="form-control" id="selCity" name="Seller[cityname]" maxlength="255">
            <option value="">-请选择-</option>
        </select>
...
<?= $form->field($model, 'realname')->textInput(['maxlength' => true, 'placeholder' => "请输入管理人的真实姓名"]) ?>
<?= $form->field($model, 'mail')->textInput(['maxlength' => true, 'placeholder' => "请输入常用邮箱，便于审核信息及后期规则的及时送达"]) ?>

<?= $form->field($model, 'mobile')->textInput(['maxlength' => true, 'placeholder' => "请输入手机号码"]) ?>
<?php //echo $form->field($model, 'mobile')->textInput(['maxlength' => true,'placeholder'=>"重复输入手机号码"]) ?>
...
<?= $form->field($model, 'business')->textInput(['maxlength' => true])->dropDownList(['生鲜水果' => '生鲜水果', '食品饮料' => '食品饮料', '居家生活' => '居家生活', '4' => '母婴玩具', '5' => '美妆护肤', '6' => '服饰箱包', '7' => '运动户外', '8' => '3C家电'], ['prompt' => '-请选择-']) ?>
<h4>企业信息</h4>

<?= $form->field($model, 'legal_person')->textInput(['maxlength' => true, 'placeholder' => "请输入企业法人的真实姓名"]) ?>

<?= $form->field($model, 'personid')->textInput(['maxlength' => true, 'placeholder' => '请输入企业法人的证件号（身份证、护照、军官证等均可）']) ?>
<div class="form-group">
    <div class="col-lg-offset-3 col-lg-8">
...
<?= $form->field($model, 'person_id_timestar')->textInput(['maxlength' => true, 'placeholder' => '请选择时间', 'id' => "datetimepicker"]) ?>

<?= $form->field($model, 'person_id_timeend')->textInput(['maxlength' => true, 'placeholder' => '请选择时间', 'id' => "datetimepicker1"]) ?>

<?= $form->field($model, 'company')->textInput(['maxlength' => true, 'placeholder' => "请输入公司名称"]) ?>

<?= $form->field($model, 'company_add')->textInput(['maxlength' => true, 'placeholder' => "请输入您的注册地址"]) ?>

<?= $form->field($model, 'company_code')->textInput(['maxlength' => true, 'placeholder' => "请输入15位营业执照注册号"]) ?>

<?= $form->field($model, 'company_organization_code')->textInput(['maxlength' => true, 'placeholder' => "请输入组织机构代码"]) ?>

<?= $form->field($model, 'company_taxpayer_identification_code')->textInput(['maxlength' => true, 'placeholder' => "请输入纳税人识别码"]) ?>

<?= $form->field($model, 'company_social_code')->textInput(['maxlength' => true, 'placeholder' => "请输入18位的统一社会信用代码"]) ?>
<div class="form-group">
    <div class="col-lg-offset-3 col-lg-8">
        <p style="color:red">
            注：如果是三证合一的营业执照，营业执照注册号，组织机构代码、纳税人识别码全部填写统一社会信用代码，非三证合一的营业执照请在统一社会信用代码处填写营业执照注册号，请根据您的营业执照类型依次填写。</p>
    </div>
</div>
<h4 style="margin-left: 25px; margin-right: 25px;">资质信息上传
    <small> (注：上传的相片5M以内，仅支持JPG、PNG格式)</small>
</h4>
...
<?= $form->field($model, 'company_business_license')->textInput(['maxlength' => true])->widget('common\widgets\file_upload\FileUpload', []) ?>

<?= $form->field($model, 'company_business_license_timestar')->textInput(['maxlength' => true, 'placeholder' => '请选择时间', 'id' => "datetimepicker2"]) ?>

<?= $form->field($model, 'company_business_license_timeend')->textInput(['maxlength' => true, 'placeholder' => '请选择时间', 'id' => "datetimepicker3"]) ?>

<?= $form->field($model, 'tax_registration_certificate')->textInput(['maxlength' => true])->widget('common\widgets\file_upload\FileUpload', []) ?>


<?= $form->field($model, 'organization_certificate')->textInput(['maxlength' => true])->widget('common\widgets\file_upload\FileUpload', []) ?>

<?= $form->field($model, 'organization_validity_period')->textInput(['maxlength' => true, 'placeholder' => "请选择时间", 'id' => "datetimepicker4"]) ?>

<?= $form->field($model, 'organization_validity_period_end')->textInput(['maxlength' => true, 'placeholder' => "请选择时间", 'id' => "datetimepicker5"]) ?>
...
<div class="form-group">
    ...
    <div class="col-lg-offset-3   col-lg-9"><label class="control-label ">(可选,最多不超过13张)填写店铺名称时如果包含"旗舰、官方"，商家必须上传"商标注册证明"。 </label>
    </div>
</div>

<?= $form->field($model, 'qc_report')->textInput(['maxlength' => true])->widget('common\widgets\file_upload\FileUpload', []) ?>
<div class="form-group">
    <div class="col-lg-offset-3   col-lg-9"><label class="control-label ">(可选,最多不超过13张)店铺名包含"旗舰、官方、专营"，商家必须上传"品牌授权或独占授权证明，<br>需授权店铺从属人在拼一下经营该品牌产品"。
        </label></div>
</div>

<?= $form->field($model, 'qc_other')->textInput(['maxlength' => true])->widget('common\widgets\file_upload\FileUpload', []) ?>
<div class="form-group">
    <div class="col-lg-offset-3 col-lg-8">
...
<?= $form->field($model, 'address')->textInput(['maxlength' => true, 'placeholder' => " 地址"]) ?>
