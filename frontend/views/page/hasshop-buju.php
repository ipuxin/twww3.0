        ...
        <div class="modal-content text-center">
            ...
            <form role="form" class="login-content mtk" style="overflow: hidden;">
                <div class="form-group">
                    <input type="text" class="form-control my-form-control" placeholder="请输入手机号">
                </div>
                <div class="form-group" id="captchaCode">
                    <img class="captcha" src="/images/yzm.jpg">
                    <input type="text" class="form-control my-form-control" placeholder="请输入右侧验证码"
                           style="border-right: 0;">
                    <span class="change">看不清<br>换一张</span>
                </div>
                <div class="form-group" id="code-input" style="float: left;">
                    <input type="text" class="form-control my-form-control" placeholder="请输入短信验证码"
    ...
    <div class="row">
        <div class="col-sm-2 has-bar">
            <div class="row has-logo">
                <a href="javascript:;" data-toggle="modal" data-target="#myModal-register"><img
                        src="/images/has_shop_03.jpg" alt="我要开店"></a>
            </div>
