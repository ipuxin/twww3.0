...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="item active xs-hide">
            <img src="/images/shhhr_02.jpg" alt="First slide">
        </div>
...
<div class="mycon">
    <div class="containe">
        <div class="row mt30">
            <img src="/images/shhhr_05.jpg" alt="" class="img-responsive center-block">
        </div>
        <div class="row my-yellow-line"></div>
        <div class="row area-tit-box">
            ...
            <div class="row">
                <div class="col-xs-10 col-md-offset-1">
                    拼一下商城是一家致力于发展本地化社交电商的购物平台，为本地经销商和商家提供入驻资源，让更多的用户带着乐趣分享实惠，以更优惠的价格购买心仪的商品。
                </div>
            </div>
        </div>
        <!----------------------------------------------------------------------------------->
            ...
            <div class="col-xs-12 col-sm-5 col-md-offset-1">
                ...
                <div class="row">
                    <div class="col-xs-8 col-md-offset-1 area-con">
                        拼一下商城是一家致力于发展本地化互联网商城的第三方移动社
                        交电商平台，为本地经销商和商家提供入驻资源，将沟通分享与
                        社交的理念融入电商运营中，形成了属于拼一下的新社交电商思
                        维，即拼一下的用户通过发起拼团邀请，在和朋友、家人、邻居
                        等一起组团成功后，以更低的价格买到当地经销代理价格的优质
                        商品。
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        ...
        <div class="row area-con-b">
            ...
            ②在本区域的商家订单佣金提成，坐享2%；③代理期间内免费享受平台技术服务和维护升级、营销支持、运营支持等七大扶持政策。<br>
