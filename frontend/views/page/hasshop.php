    ...
    <div class="row">
        <div class="col-sm-2 has-bar">
            <div class="row has-logo">
                <img src="/images/has_shop_03.jpg" alt="我要开店">
            </div>
                        ...
                        <div class="containe">
                            <div class="row mt30">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <a href="" style="float:left;"  data-toggle="modal"  data-target="#myModal1"><img src="/images/rzlc_04.png" alt="咨询问题"></a>
                                </div>
                            </div>
                        ...
                        <div class="containe">
                            ...
                            <div class="row">
                                <div class="container my-hasshop-fz">
                                    ...
                                    <p><img class="img-responsive" src="/images/busguide-0101.png" alt="登录商家后台" title="登录商家后台"
                                            style="max-width:421px ; "></p>
                                    2、登录商家后台首先完善我的资料和我的店铺相关信息。
                                    <p>我的资料：</p>
                                    <p><img class="img-responsive" src="/images/busguide-0201.png" alt="我的资料" title="我的资料"
                                            style="max-width:745px ; "></p>
                                    <p>我的店铺：</p>
                                    <p><img class="img-responsive" src="/images/busguide-0202.png" alt="我的资料" title="我的资料"
                                    ...
                                    3、商品编辑
                                    <p>商品列表:</p>
                                    <p><img class="img-responsive" src="/images/busguide-0301.png" alt="商品列表" title="商品列表"
                                            style="max-width:1342px ; "></p>
                                    <p>已发布商品修改，在商品列表中点击产品名称或编辑，进入编辑页面进行修改。</p>
                                    4、发布商品
                                    <p>基本信息</p>
                                    <p><img class="img-responsive" src="/images/busguide-0401.png" alt="基本信息" title="基本信息"
                                    ...
                                    <p>拼团设置</p>
                                    <p><img class="img-responsive" src="/images/busguide-0402.png" alt="拼团设置" title="拼团设置"
                                    ...
                                    5、优惠券设置
                                    <p><img class="img-responsive" src="/images/busguide-0501.png" alt="拼团设置" title="拼团设置"
                                    ...
                                    6、订单单个发货
                                    <p><img class="img-responsive" src="/images/busguide-0601.png" alt="单个订单发货" title="单个订单发货"
                                            style="max-width:962px; "></p>
                                    <p><em>单个订单发货：</em>进入待发货订单详情，输入快递单号，选择使用快递商，更改订单状态为已发货，点击保存。</p>
                                    <p style="color: #999;">注：快递商在设置中添加</p>
                                    7、订单批量发货
                                    <p><img class="img-responsive" src="/images/busguide-0701.png" alt="订单批量发货" title="订单批量发货"
                                            style="max-width: 807px; "></p>
                                    <p><em>订单导出：</em>订单状态选择待发货，选择对应下单时间，点击导出，将文件保存到桌面。</p>
                                    <p><img class="img-responsive" src="/images/busguide-0702.png" alt="订单导出" title="订单导出"
                                    ...
                                    8、快递商设置
                                    <p><img class="img-responsive" src="/images/busguide-0801.png" alt="快递商设置" title="快递商设置"
