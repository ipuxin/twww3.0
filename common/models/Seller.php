...
class Seller extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['cityname', 'realname', 'mobile', 'mail', 'password', 'business', 'legal_person', 'personid', 'company', 'company_add', 'company_code', 'company_organization_code', 'company_taxpayer_identification_code', 'company_social_code', 'personpica', 'personpicb', 'company_business_license', 'tax_registration_certificate', 'organization_certificate', 'address', 'shopname', 'shoplogo'], 'required'],
            [['status', 'created_at', 'updated_at'], 'integer'],
            [['username', 'cityname', 'realname', 'mobile', 'mail', 'shopinfo', 'password', 'business', 'legal_person', 'personid', 'person_id_timestar', 'person_id_timeend', 'company', 'company_add', 'company_code', 'company_organization_code', 'company_taxpayer_identification_code', 'company_social_code', 'personpica', 'personpicb', 'company_business_license', 'company_business_license_timestar', 'company_business_license_timeend', 'tax_registration_certificate', 'organization_certificate', 'organization_validity_period', 'organization_validity_period_end', 'address', 'trademark', 'brand_certificate', 'qc_report', 'qc_other', 'shopname', 'shoplogo', 'zhifubaoaccount', 'type'], 'string', 'max' => 255],
            [['username'], 'unique'],
            [['mobile'], 'unique'],
            [['mail'], 'unique'],
            [['company'], 'unique'],
...
//      ,
    ...
    public function attributeLabels()
    {
        return [
            ...
            'shopinfo' => Yii::t('shop', 'shopinfo'),
            'zhifubaoaccount' => Yii::t('shop', 'zhifubaoaccount'),
            'type' => Yii::t('type', 'type'),
