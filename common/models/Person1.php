...
//            [[  'cityname', 'realname', 'mobile', 'email', 'password'  ], 'required'],
            ...
            [['username', 'cityname', 'realname', 'mobile', 'shopinfo', 'email', 'password', 'personid', 'business', 'personpica', 'personpicb', 'person_id_timestar', 'person_id_timeend', 'person_id_andheadpic', 'person_halfbody', 'trademark', 'brand_certificate', 'qc_report', 'qc_other', 'shopname', 'shoplogo', 'address', 'zhifubaoaccount' ,'type'], 'string', 'max' => 255],
            [['username'], 'unique'],
            [['mobile'], 'unique'],
            [['email'], 'unique'],
            [['personid'], 'unique'],
